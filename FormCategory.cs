...
namespace CourseDataBase
{
    public partial class FormCategory : Form
    {
        ...
        private void toolStripButtonSave_Click(object sender, EventArgs e)
        {
            try
            {
                categoryTableAdapter.Update(this.storeDataSet);
        ...
        private void buttonCountGood_Click(object sender, EventArgs e)
        {
            FormCTReport formCTReport = new FormCTReport();
            formCTReport.ShowDialog();
        }
    }
}
